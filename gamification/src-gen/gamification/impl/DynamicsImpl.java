 ...
 * </p>
 * <ul>
 *   <li>{@link gamification.impl.DynamicsImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicsImpl extends MinimalEObjectImpl.Container implements Dynamics {
	...
	protected EClass eStaticClass() {
		return GamificationPackage.Literals.DYNAMICS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GamificationPackage.DYNAMICS__NAME, oldName, name));
	}
